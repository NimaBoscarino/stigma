...
application = Booking.create client: jim, artist: fearbear
tattoo_job = TattooInformation.create ({
...
application.appointments.create date: 8.days.from_now, name: '1st session', description: 'outlines and stuff', client: application.client, artist: application.artist
application.appointments.create date: 15.days.from_now, name: '2nd session', description: 'colours! bring something to eat', client: application.client, artist: application.artist
