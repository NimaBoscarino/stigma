...
pam = Artist.create name: 'Pam Beesly', username: 'pam', avatar: '/assets/pam.jpg', email: 'pam@test.com', password: 'artist'
michael = Artist.create name: 'Michael Scott', username: 'michael', avatar: '/assets/michael.jpg', email: 'michael@test.com', password: 'artist'
...
jim.followings.create artist: pam
jim.followings.create artist: michael

dwight.followings.create artist: michael
...
application = Application.create client: jim, artist: pam
...
application = Application.create client: dwight, artist: michael
tattoo_job = TattooInformation.create ({
  subject: 'I want a floral tattoo',
  description: 'Lots of sunflowers',
  placement: 'on my face',
...
# booking = Booking.create client: nima, artist: michael
# tattoo_job = TattooInformation.create ({
...
# booking.appointments.create date: 4.days.from_now, name: '1st session', description: 'outlines and stuff', client: booking.client, artist: booking.artist
# booking.appointments.create date: 10.days.from_now, name: '2nd session', description: 'colours! bring something to eat', client: booking.client, artist: booking.artist


booking = Booking.create client: jim, artist: michael
tattoo_job = TattooInformation.create ({
  subject: 'My wife\'s face',
  description: 'I want her face to be on mine',
  placement: 'on my face',
  consultation: true,
  coverUp: false,
  interaction: booking
...
pam.photos.create url: '/assets/3.jpg'
pam.photos.create url: '/assets/4.jpg'
pam.photos.create url: '/assets/5.jpg'
pam.photos.create url: '/assets/6.jpg'
pam.photos.create url: '/assets/7.jpg'

michael.photos.create url: '/assets/8.jpg'
michael.photos.create url: '/assets/9.jpg'
michael.photos.create url: '/assets/10.jpg'
michael.photos.create url: '/assets/11.jpg'
michael.photos.create url: '/assets/12.jpg'
michael.photos.create url: '/assets/13.jpg'
...
pam.events.create name: 'Flash Event', date: 1.days.from_now
pam.events.create name: 'Flash Event', date: 4.days.from_now
pam.events.create name: 'Flash Event', date: 3.days.ago
pam.events.create name: 'Flash Event', date: 10.days.from_now

michael.events.create name: 'Flash Event', date: 6.days.from_now
michael.events.create name: 'Flash Event', date: 2.days.from_now
michael.events.create name: 'Flash Event', date: 7.days.ago
michael.events.create name: 'Flash Event', date: 9.days.from_now
...
ArtistInformation.create artist: pam, books_open: true
ArtistInformation.create artist: michael, books_open: false
